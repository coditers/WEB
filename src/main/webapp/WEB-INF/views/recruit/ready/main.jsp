            ...
            <div class="card-panel white">
                <div class="row">
                    <div class="col s10 offset-s1">
                            ...
                            <div class="collection">
                                <li id="li-setperiods" class="collection-item bold"><i
                                    ...
                                    <form id="form-selectdate"
                                          action="${pageContext.request.contextPath}/recruit/${recruitVo.id}/set-recruitdate"
                                          method="POST">
                                        <input value="${recruitVo.fromDate}" name="fromDate" id="fromDate" type="date"
                                               class="datepicker">
                                        ~
                                        <input value="${recruitVo.toDate}" name="toDate" id="toDate" type="date"
                                               class="datepicker">
                                        <button type="submit" id="btn-datesave"
                                                class="waves-effect waves-orange white btn-flat right-align">save
                                        </button>
                                    </form>
                                </li>
                                <a href="${pageContext.request.contextPath}/recruit/${recruitVo.id}/appregform"
                                   class="collection-item bold"><i class="small material-icons">perm_identity</i>Enroll
                                    applicants
                                    <span class="badge"
                                          data-badge-caption="custom caption">${applicantCount} enrolled</span>
                                </a>
                                <a href="${pageContext.request.contextPath}/recruit/${recruitVo.id}/problem-selectform"
                                   class="collection-item bold "><i class="small material-icons">list</i>Select
                                    test problems
                                    <span class="badge"
                                          data-badge-caption="custom caption">${problemCount} selected </span>
                                </a>
                                <a href="${pageContext.request.contextPath}/recruit/${recruitVo.id}/write-emailform"
                                   class="collection-item bold "><i
                        ...
                        <div class="row center">
                            <a id="btn-sendInvitations"
                               class="btn-large waves-effect waves-light brown center modal-trigger"
                               href="#modal-confirm">Send invitations!
                                ...
                                <div class="modal-content">
                                    ...
                                    <div row>
                                        <div class="col s6 offset-s3">
                                            ...
                                            <div class="center">
                                                <a id="modal-a-sendInvitations"
                                                   href="${pageContext.request.contextPath}/recruit/${recruitVo.id}/send-ticket">
                                                    <button id="modal-btn-sendInvitations"
...
<script>
    $(document).ready(function () {
        ...
        $('#btn-sendInvitations').click(function () {
            ...
            if (toDate == "") {
                message += "<br>*Please set the closing date.";
            }
            if (applicantCount == "0") {
                message += "<br>*Please enroll applicants.";
            }
            if (problemCount == "0") {
                message += "<br>*Please select test problems.";
            }
            if (emailFormat == "") {
                message += "<br>*Please save email format.\n";
            }
